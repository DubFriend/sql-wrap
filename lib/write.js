...
module.exports = function (_ref) {
  ...
  self.insert = function (table, rowOrRows) {
    ...
    if (rows.length) {
      ...
      return _bluebird2.default.all(_lodash2.default.map(grouped, function (rows, key) {
        return query.build().insert().into((0, _wrapUptick2.default)(table)).setFieldsRows(_lodash2.default.map(rows, function (r) {
  ...
  self.replace = function (table, rowOrRows) {
    ...
    if (rows.length) {
      ...
      return _bluebird2.default.all(_lodash2.default.map(grouped, function (rows, key) {
        return query.build().replace().into((0, _wrapUptick2.default)(table)).setFieldsRows(_lodash2.default.map(rows, function (r) {
          return _lodash2.default.mapKeys(r, function (v, k) {
            return (0, _wrapUptick2.default)(k);
          });
        })).run().then(function (resp) {
