...
module.exports = function (_ref) {
  ...
  self.update = function (table, updates, where) {
    if (Array.isArray(updates)) {
      ...
      var queries = _lodash2.default.map(updates, function (_ref2) {
        var update = _ref2.update,
            where = _ref2.where;

        var q = query.build().update().table((0, _wrapUptick2.default)(table)).setFields(prepareWriteData(update));
      ...
      return driver.query({
        sql: _lodash2.default.map(queries, function (_ref3) {
          var text = _ref3.text;
          return text;
        }).join(';\n'),
        values: _lodash2.default.chain(queries).map(function (_ref4) {
